///src/app/uk/birmingham/fixture-congestion/page.tsx
...
export const metadata: Metadata = {
  title:
    "Birmingham Fixture Congestion — Live Match Overlap & Scheduling Analysis",
  description:
    "Live fixture congestion analysis across Birmingham, highlighting peak kickoff overlap windows, concurrent professional fixtures and operational scheduling pressure.",
  alternates: {
    canonical: "https://venuescope.io/uk/birmingham/fixture-congestion",
  },
};
...
export default async function Page() {
  ...
  const articleData = {
    ...
    description:
      "Live fixture congestion analysis across Birmingham, highlighting peak kickoff overlap windows and scheduling pressure.",
    author: {
      "@type": "Organization",
      name: "VenueScope",
    },
    ...
    mainEntityOfPage: {
      "@type": "WebPage",
      "@id": "https://venuescope.io/uk/birmingham/fixture-congestion",
    },
  };
    ...
    <main className="max-w-3xl mx-auto px-6 py-10 space-y-10">
      ...
      <header className="space-y-1">
        ...
        <p className="text-muted-foreground leading-relaxed">
          A total of {birminghamEvents.length} professional sporting
          fixture{birminghamEvents.length !== 1 ? "s" : ""} are
          scheduled across Birmingham today.
        </p>
      ...
      <section className="space-y-6">
        ...
        <p className="text-muted-foreground leading-relaxed">
          Event clustering across major venues in Birmingham
