// src/app/uk/manchester/sports/[date]/page.tsx
...
export async function generateMetadata(
  ...
  return {
    title: `Sports Fixtures in Manchester — ${displayDate} | VenueScope`,
    description: `Professional sports fixtures taking place in Manchester on ${displayDate}, organised by venue and start time.`,
    alternates: {
      canonical: `https://venuescope.io/uk/manchester/sports/${date}`,
    },
  };
}
    ...
    <main className="max-w-3xl mx-auto px-6 py-16 space-y-8">
      ...
      <header className="space-y-4">
        <h1 className="text-3xl font-bold">
          Sports Fixtures in Manchester — {displayDate}
        </h1>

        <p className="text-muted-foreground">
          There are {dateEvents.length} professional sporting events
          taking place in Manchester on {displayDate}.
      ...
      <section className="mt-6 space-y-2 text-sm">
        ...
        >
          Football fixtures in Manchester on {displayDate}
        </Link>
        ...
        <Link
          ...
          className="underline block"
        >
          View today’s Manchester fixtures
        </Link>
      </section>
