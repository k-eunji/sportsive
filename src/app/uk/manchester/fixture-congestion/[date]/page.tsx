//src/app/uk/manchester/fixture-congestion/[date]/page.tsx
...
export async function generateMetadata(
  ...
  return {
    title: `Manchester Fixture Congestion — ${displayDate}`,
    ...
    alternates: {
      canonical: `https://venuescope.io/uk/manchester/fixture-congestion/${date}`,
    },
  };
}
    ...
    <main className="max-w-3xl mx-auto px-6 py-10 space-y-10">
      ...
      <header className="space-y-6">
        ...
        <p className="text-muted-foreground leading-relaxed">
          {isPast &&
            `A total of ${manchesterEvents.length} professional fixtures were held across Manchester on this date.`}
          {isToday &&
            `A total of ${manchesterEvents.length} professional fixtures are scheduled across Manchester today.`}
          {isFuture &&
            `A total of ${manchesterEvents.length} professional fixtures are scheduled across Manchester on this date.`}
        </p>
      ...
      <section className="pt-8 border-t flex justify-between text-sm">
        ...
        <Link
          href={`/uk/manchester/fixture-congestion/${prevDate}`}
          className="underline"
        >
          ← Previous day
        </Link>
        ...
        <Link
          href={`/uk/manchester/fixture-congestion/${nextDate}`}
          className="underline"
        >
          Next day →
        </Link>
      ...
      <section className="space-y-6">
        ...
        <Link
          href="/uk/manchester/fixture-congestion"
          className="underline underline-offset-4"
        >
          View live Manchester congestion overview →
        </Link>
