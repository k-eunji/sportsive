//src/app/uk/wales/fixture-congestion/page.tsx
...
export const metadata: Metadata = {
  title:
    "Wales Fixture Congestion — Live Match Overlap & Scheduling Analysis",
  description:
    "Live fixture congestion analysis across Wales, highlighting peak kickoff overlap windows, concurrent professional fixtures and operational scheduling pressure.",
  alternates: {
    canonical: "https://venuescope.io/uk/wales/fixture-congestion",
  },
};
...
export default async function Page() {
  ...
  const articleData = {
    ...
    mainEntityOfPage: {
      "@type": "WebPage",
      "@id": "https://venuescope.io/uk/wales/fixture-congestion",
    },
  };
    ...
    <main className="max-w-3xl mx-auto py-10 space-y-10">
      ...
      <header className="space-y-6">
        ...
        <p className="text-muted-foreground leading-relaxed">
          A total of {walesEvents.length} professional sporting
          fixture{walesEvents.length !== 1 ? "s" : ""} are
          scheduled across Wales today.
        </p>
      ...
      <section className="space-y-6">
        ...
        <p className="text-muted-foreground leading-relaxed">
          ...
          areas such as Cardiff, Swansea and Newport,
