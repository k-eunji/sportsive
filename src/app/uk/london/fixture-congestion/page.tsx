//src/app/uk/london/fixture-congestion/page.tsx
...
export const metadata: Metadata = {
  title:
    "London Fixture Congestion — Live Match Overlap & Scheduling Analysis",
  description:
    "Live fixture congestion analysis across London, highlighting peak kickoff overlap windows, concurrent professional fixtures and operational scheduling pressure.",
  alternates: {
    canonical: "https://venuescope.io/uk/london/fixture-congestion",
  },
};
...
export default async function Page() {
  ...
  const peakRatio =
    peak && londonEvents.length > 0
      ? Math.round((peak[1] / londonEvents.length) * 100)
      : 0;
  ...
  const breadcrumbData = {
    ...
    itemListElement: [
      ...
      },
      {
        ...
        position: 2,
        name: "London",
        item: "https://venuescope.io/uk/london/fixture-congestion",
      },
    ],
  };
    ...
    <main className="max-w-3xl mx-auto px-6 py-10 space-y-10">
      ...
      <header className="space-y-1">
        ...
        <h1 className="text-4xl font-bold leading-tight">
          London Fixture Congestion Report — {displayDate}
        </h1>

        <p className="text-muted-foreground leading-relaxed">
          A total of {londonEvents.length} professional sporting
          fixture{londonEvents.length !== 1 ? "s" : ""} are
          scheduled across London today.
        </p>
      ...
      <section className="space-y-6">
        ...
        <p className="text-muted-foreground leading-relaxed">
          Event clustering across major venues such as Wembley,
          Emirates Stadium and Tottenham Hotspur Stadium
          may increase transport demand, stewarding requirements
          and policing coordination pressure within the capital.
        </p>
