//src/app/uk/london/fixture-congestion/[date]/page.tsx
...
export default async function Page({ params }: Props) {
  ...
  const articleData = {
    ...
    mainEntityOfPage: {
      "@type": "WebPage",
      "@id": `https://venuescope.io/uk/london/fixture-congestion/${date}`,
    },
  };
    ...
    <main className="max-w-3xl mx-auto px-6 py-10 space-y-10">
      ...
      <header className="space-y-6">
        ...
        <p className="text-muted-foreground leading-relaxed">
          {isPast &&
            `A total of ${londonEvents.length} professional fixtures were held across London on this date.`}
          {isToday &&
            `A total of ${londonEvents.length} professional fixtures are scheduled across London today.`}
          {isFuture &&
            `A total of ${londonEvents.length} professional fixtures are scheduled across London on this date.`}
        </p>
      ...
      <section className="space-y-6">
        ...
        <Link
          href="/uk/london/fixture-congestion"
          className="underline underline-offset-4"
        >
          View live London congestion overview →
        </Link>
