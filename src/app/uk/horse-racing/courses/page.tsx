// src/app/uk/horse-racing/courses/page.tsx
...
export const metadata: Metadata = {
  title:
    "UK Horse Racing Courses 2026 – Ranking, Congestion & Meeting Volume",
  description:
    "Compare UK racecourses in 2026 by meeting volume, congestion index, weekend concentration and structural density.",
};
    ...
    <main className="max-w-5xl mx-auto px-6 py-14 space-y-16">
      ...
      <header className="space-y-4 border-b pb-8">
        ...
        <h1 className="text-4xl font-semibold tracking-tight">
          UK Horse Racing Courses – 2026 Structural Analysis
        </h1>

        <p className="text-sm text-muted-foreground max-w-2xl">
          Comparative analysis of UK racecourses based on fixture
