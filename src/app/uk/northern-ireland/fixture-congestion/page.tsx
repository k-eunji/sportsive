// src/app/uk/northern-ireland/fixture-congestion/page.tsx
...
export const metadata: Metadata = {
  title:
    "Northern Ireland Fixture Congestion — Live Match Overlap & Scheduling Analysis",
  description:
    "Live fixture congestion analysis across Northern Ireland, highlighting peak kickoff overlap windows, concurrent professional fixtures and operational scheduling pressure.",
  alternates: {
    canonical:
      "https://venuescope.io/uk/northern-ireland/fixture-congestion",
  },
};
...
export default async function Page() {
  ...
  const articleData = {
    ...
    mainEntityOfPage: {
      "@type": "WebPage",
      "@id": "https://venuescope.io/uk/northern-ireland/fixture-congestion",
    },
  };
    ...
    <main className="max-w-3xl mx-auto px-6 py-10 space-y-10">
      ...
      <header className="space-y-1">
        ...
        <p className="text-muted-foreground leading-relaxed">
          A total of {niEvents.length} professional sporting
          fixture{niEvents.length !== 1 ? "s" : ""} are
          scheduled across Northern Ireland today.
        </p>
