...
export async function generateMetadata(
  ...
  return {
    title: `Ireland Horse Racing ${month}/2026 – Monthly Meeting Analysis`,
    description:
      `Detailed breakdown of Ireland horse racing meetings during ${month}/2026 including daily schedule and structural density.`,
  };
}
...
export default async function Page({ params }: Props) {
  ...
  const articleData = {
    ...
    "@type": "Article",
    headline: `Ireland Horse Racing ${monthLabel}`,
    description:
      "Monthly structural overview of Ireland horse racing meetings.",
    author: {
      "@type": "Organization",
      name: "VenueScope",
    },
    ...
    <main className="max-w-4xl mx-auto px-6 py-14 space-y-14">
      ...
      <header className="space-y-4 border-b pb-8">
        ...
        <h1 className="text-3xl font-bold">
          Ireland Horse Racing – {monthLabel}
        </h1>
      ...
      <section className="pt-8 border-t text-sm space-y-2">
        ...
        <ul className="underline space-y-1">
          ...
          <li><Link href="/ireland/horse-racing/calendar-2026">Full Calendar</Link></li>
          <li><Link href="/ireland/horse-racing/busiest-days-2026">Busiest Days</Link></li>
          <li><Link href="/ireland/horse-racing/meeting-frequency-2026">Course Ranking</Link></li>
        </ul>
      </section>
