...
export const metadata: Metadata = {
  title: "Ireland Horse Racing Calendar 2026 – Total Meetings, Busiest Days & Overlap Analysis",
  description:
...
export default async function Page() {
  ...
  const racing2026 = events.filter((e: any) => {
    ...
    return (
      IRELAND_REGIONS.includes(region) &&
      year === 2026 &&
      month >= 1
    );
  });
  ...
  const faqData = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "How many Ireland horse racing meetings are scheduled in 2026?",
        acceptedAnswer: {
          "@type": "Answer",
          text: `There are ${totalMeetings} race meetings scheduled across Ireland in 2026.`,
        },
      },
      {
        "@type": "Question",
        name: "What is the busiest Ireland horse racing day in 2026?",
        acceptedAnswer: {
          "@type": "Answer",
          text: busiestDay
      ...
      {
        "@type": "Question",
        name: "Which month has the most Ireland race meetings in 2026?",
        acceptedAnswer: {
          "@type": "Answer",
          text: peakMonth
      ...
      },
      {
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: `Saturday meetings represent ${saturdayShare}% of all Ireland race meetings in 2026.`,
        },
      },
      {
        "@type": "Question",
        name: "Is the 2026 Ireland racing calendar congested?",
        acceptedAnswer: {
          "@type": "Answer",
    ...
    <main className="max-w-4xl mx-auto px-6 py-14 space-y-14">
      ...
      <header className="space-y-4 border-b pb-8">
        ...
        <p className="text-sm text-muted-foreground max-w-2xl">
          Complete structural overview of Ireland race meetings in 2026,
      ...
      <section className="pt-10 border-t text-sm text-muted-foreground space-y-3">
        ...
        <p>
          ...
          the 2026 Ireland racing calendar reflects 
          {avgPerDay >= 3
      ...
      <section className="pt-10 border-t space-y-6">
        ...
        <p className="text-sm text-muted-foreground">
          Meeting distribution across Ireland regions.
        </p>
      ...
      <section className="pt-10 border-t space-y-6">
        ...
        <p className="text-sm text-muted-foreground">
          ...
          within the 2026 Ireland racing calendar.
        </p>
      </section>
      ...
      <section className="space-y-10">
        ...
        <div>
          <h2 className="text-xl font-semibold">
            When does the 2026 Ireland horse racing season peak?
          </h2>
        ...
        <div>
          <h2 className="text-xl font-semibold">
            What is the busiest Ireland racing day in 2026?
          </h2>
          {busiestDay && (
            <p className="text-sm text-muted-foreground mt-3 leading-relaxed">
        ...
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-3 leading-relaxed">
            Saturdays represent <strong>{saturdayShare}%</strong> of all Ireland
        ...
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-3 leading-relaxed">
            ...
            <strong>{top5Share}%</strong> of all Ireland meetings,
      ...
      <section className="pt-10 border-t space-y-6">
        <h2 className="text-xl font-semibold">
          Leading Ireland Racecourses in 2026
        </h2>
      ...
      <div className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-black text-white text-sm hover:opacity-90 transition">
        ...
        >
          View full Ireland course ranking →
        </Link>
      </div>
      ...
      <section className="pt-12 border-t space-y-8">
        <h2 className="text-2xl font-semibold">
          Frequently Asked Questions – Ireland Horse Racing 2026
        </h2>
        ...
        <div className="space-y-6 text-sm text-muted-foreground">
          ...
          <div>
            ...
            <p className="mt-2">
              ...
              scheduled across Ireland in 2026.
            </p>
          </div>
      ...
      <section className="pt-10 border-t text-sm space-y-2">
        <h2 className="font-semibold">Ireland Horse Racing Hub</h2>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Article",
            headline: "Ireland Horse Racing Calendar 2026",
            description:
              "Structural overview of Ireland horse racing meetings in 2026 including total meetings, congestion patterns and overlap analysis.",
            author: {
              "@type": "Organization",
              name: "VenueScope",
            },
