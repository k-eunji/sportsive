...
export async function generateMetadata(
  ...
  return {
    ...
    description:
      `Professional sports fixtures taking place across Ireland on ${displayDate}, organised by city and venue.`,
    alternates: {
...
export default async function IrelandSportsByDatePage(
  { params }: Props
) {
  const { date } = await params;
